...
DEST_LOCATION = '~/Desktop/jasonlee-github-blog/JasonLee-cp.github.io/_posts/Algorithm/bfsdfs/'
TITLE_PREFIX = '[DFS] ' # This is for "[category] title..." format. Replace with '' if you don't need it.
POST_CATEGORY = 'bfsdfs' # Jekyll post category
POSTING_DATE = '2022-02-03-' # Posting date
TAGS = ['algorithm', 'dfs', 'leetcode'] # List of tags for your post
