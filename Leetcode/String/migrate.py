...
DEST_LOCATION = '~/Desktop/jasonlee-github-blog/JasonLee-cp.github.io/_posts/Algorithm/string/'
TITLE_PREFIX = '[String] ' # This is for "[category] title..." format. Replace with '' if you don't need it.
POST_CATEGORY = 'string' # Jekyll post category
POSTING_DATE = '2022-02-03-' # Posting date
TAGS = ['algorithm', 'string', 'leetcode'] # List of tags for your post
