...
DEST_LOCATION = '~/Desktop/jasonlee-github-blog/JasonLee-cp.github.io/_posts/Algorithm/Tree/'
TITLE_PREFIX = '[Tree] ' # This is for "[category] title..." format. Replace with '' if you don't need it.
POST_CATEGORY = 'tree' # Jekyll post category
POSTING_DATE = '2022-02-03-' # Posting date
TAGS = ['algorithm', 'tree', 'leetcode'] # List of tags for your post
